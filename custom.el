...
(custom-set-variables
 ...
 '(package-selected-packages
   '(all-the-icons auctex avy catppuccin-theme cmake-font-lock cmake-ide
				   ...
				   meson-mode minions moody org-bullets
				   pip-requirements projectile-ripgrep python-mode
				   pyvenv tide tldr tree-sitter-langs use-package
				   wfnames which-key yasnippet))
